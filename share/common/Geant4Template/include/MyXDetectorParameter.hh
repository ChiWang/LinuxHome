...
#------------------------------------------------------------------------------
#       Description  :
#           declear all const variables here, define in src/MyXGlobal.cc. Any file want to use variables defined here just #include MyXGlobal.hh
