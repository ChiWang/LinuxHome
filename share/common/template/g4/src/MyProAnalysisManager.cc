/*=============================================================================
#       FileName :          MyProAnalysisManager.cc
#       Version  :          0.0.1
#       Author   :          Chi WANG    (chiwang@mail.ustc.edu.cn)
#       Time     :          2013-11-16   07:36:57
#------------------------------------------------------------------------------
#       Description  :
#
#------------------------------------------------------------------------------
#       History  :
#                                          Update:  2013-11-16   07:36:57
=============================================================================*/
...
MyProAnalysisManager::MyProAnalysisManager()
 :fRFile=0
{}
...
MyProAnalysisManager* MyProAnalysisManager::GetInstance(){
  if (fInstance == 0) {
    fInstance = new MyProAnalysisManager()
  }
  return fInstance;
}
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void MyProAnalysisManager::BeginOfRun(const G4Run* aRun){

}

void MyProAnalysisManager::EndOfRun(const G4Run* aRun){

}

void MyProAnalysisManager::BeginOfEvent(const G4Event* aEvent){

}

void MyProAnalysisManager::EndOfEvent(const G4Event* aEvent){
  runaction->epamDataTree->Fill();
}

void MyProAnalysisManager::UserStepping(const G4Step* aStep){
